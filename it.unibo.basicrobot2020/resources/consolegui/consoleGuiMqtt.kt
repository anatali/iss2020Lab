...
class consoleGuiMqtt() :  consoleGuiBase(), MqttCallback {
	companion object{
		fun create(port: String = "1883", destActor: String ="basicrobot"){
			consoleGuiBase.createGui( ConnectionType.MQTT, "localhost", port, destActor)
		}
	}
...
fun main(){ 
	...
	consoleGuiBase.createGui( ConnectionType.MQTT, "localhost", "1883", "basicrobot")
}
