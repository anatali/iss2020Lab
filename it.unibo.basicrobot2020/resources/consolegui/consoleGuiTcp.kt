...
class consoleGuiTcp() : consoleGuiBase() {
	companion object{
		fun create(port: String = "8018", destActor: String ="basicrobot"){
			consoleGuiBase.createGui( ConnectionType.TCP, "localhost", port, destActor)
		}
	}
...
fun main(){
	consoleGuiBase.createGui( ConnectionType.TCP, "localhost", "8018", "basicrobot")
}
