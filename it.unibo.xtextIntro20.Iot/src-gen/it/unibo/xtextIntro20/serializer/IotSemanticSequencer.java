 ...
 */
package it.unibo.xtextIntro20.serializer;
...
public class IotSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	protected void sequence_Request(ISerializationContext context, Request semanticObject) {
		...
		feeder.accept(grammarAccess.getRequestAccess().getMsgSTRINGTerminalRuleCall_3_0(), semanticObject.getMsg());
		feeder.finish();
	}
