...
private BufferedReader inputChannel;
	...
	public void closeConnection() throws Exception{
		println("SocketTcpConnSupport |  CLOSING port " + socket.getPort());
		socket.close();
	}
	...
	public  String receiveALine( int timeOut ) throws Exception{
 		println( "SocketTcpConnSupport |  receiveALine " + Thread.currentThread().getName()  + " on "+ socket.getLocalPort());
 		try {
...
//				println( "has read " + n + " bytes\n"  + (char)b[msgLength-1]  );
			...
			println( "SocketTcpConnSupport | has received ... " +cmd  );
			return cmd;			
	}
