...
public class ResourceSonarClient {
	public static void main(String[] args) {
 		//CoapClient client = new CoapClient("coap://localhost:5683/robot/sonar");
 		CoapClient client = new CoapClient();
 		client.setURI("coap://localhost:5683/robot/sonar");
		...
		System.out.println("RESPONSE 2 CODE: " + resp2.getCode());
 		...
 		client.setURI("coap://localhost:5683/robot");
		CoapResponse resp3 = client.put("inc", MediaTypeRegistry.TEXT_PLAIN);
		System.out.println("RESPONSE 3 CODE: " + resp3.getCode());
