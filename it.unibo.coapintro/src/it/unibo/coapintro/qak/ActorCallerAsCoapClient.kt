...
object ActorCallerAsCoapClient {
    ...
    fun useBasicrobot(client: CoapClient) {
        val uriStr = "coap://localhost:5683/ctxBasicRobot/basicrobot"
        client.uri = uriStr
        println("USING: $uriStr")
        val respGet = client.get()
        println("GET RESPONSE CODE= " + respGet.code + " content:" + respGet.responseText)
     ...
     fun main( ) {
        ...
        println("-------------------------")
        ActorCallerAsCoapClient.useBasicrobot(client)
    }
