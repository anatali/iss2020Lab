...
//		actor.solve("assert( curPos($posx,$posy,$direction) )")			
	...
	suspend fun rotate(actor:ActorBasic,move:String,pauseTime:Int=PauseTime){
 	...
 	fun rotateRight90(actor : ActorBasic ){
	...
	fun rotateLeft90( actor : ActorBasic ){
	...
	suspend fun rotateLeft90tuning( actor : ActorBasic ){
 	...
 	suspend fun moveAhead(
 	  actor:ActorBasic, stepTime:Int, pauseTime:Int = PauseTime, dest:String ="resourcemodel"){
