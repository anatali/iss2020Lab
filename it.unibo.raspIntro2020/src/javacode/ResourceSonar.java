...
private String msg = "";
	...
	public void handleGET(CoapExchange exchange) {
		System.out.println("Resource " + getName() + " | handleGET from:" + exchange.getRequestText() + " arg:" + exchange.getRequestText()  );
		exchange.respond("Resource | current event= " + msg);
	}
 ...
 */
	...
	public void handlePUT(CoapExchange exchange) {
		System.out.println("Resource " + getName() + " | PUT arg=" + exchange.getRequestText() );
		msg = exchange.getRequestText();
